...
export const SYMPTOM_TIPS: Record<string, string> = {
  ...
  acne:                'Your skin is more reactive right now — keep your routine simple and gentle.',
  ...
  'food cravings':     'Cravings signal what your body needs — lean into nourishing versions.',
  ...
  discharge:           'Changes in discharge through your cycle are normal — note the pattern.',
...
export const PHASE_INSIGHT_TIPS: Record<CyclePhase, string[]> = {
  ...
  ovulation: [
    'Your social energy is near its peak — high-stakes conversations and creative bursts come more easily now.',
    'This is one of the best windows in your cycle for physical performance.',
    'Your skin and hair often look their best around ovulation — enjoy it.',
  ],
  luteal: [
    'Your intuition tends to be sharper now. Trust what you notice.',
    'This phase can amplify stress — reducing your load where possible is genuinely useful, not a luxury.',
