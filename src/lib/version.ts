...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    date: '2026-08-17',
    major: true,
    title: 'Your turn to shape it',
    art: 'message',
    highlights: [
      'Whatever is good about Nila is good because people said what was not working for them. Settings now has a direct line to the person who makes it, so that can carry on',
      'Send a bug, a feature you want, or a thought you have not finished having. Bugs get fixed quickly and ideas are weighed for the next version',
      'What you log stays encrypted and stays out of it. The message carries only your version and the sort of device you are on, so you never have to describe the screen',
      'Offline, or it could not get through? It waits on your device and sends itself once you are back. Write it and forget it',
      'Replies arrive at the email you signed up with, so there is nothing to check and nothing to miss',
    ],
    howTo: [
      'Open Settings, find "Make Nila Yours", and pick whether it is a bug or an idea.',
    ],
  },
  {
    version: '2.4.0',
