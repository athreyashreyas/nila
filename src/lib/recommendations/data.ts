...
const DB: Record<CyclePhase, PhaseRec> = {
  period: {
    ...
    foods: [
      ...
      { name: 'Leafy greens', emoji: '🥬', reason: 'Iron and vitamin C, best absorbed together', veg: true },
    ...
    lifestyle: 'Rest without guilt. Heat on your lower abdomen genuinely helps. Light walks beat high intensity, so protect your energy.',
  ...
  follicular: {
    ...
    lifestyle: 'Great time to begin something new. Your brain is at its clearest, so use it for hard thinking and creative projects.',
  ...
  ovulation: {
    ...
    lifestyle: 'High-intensity workouts, big conversations, and important decisions all feel easier now. Lean in.',
