...
export const GUIDE: GuideSection[] = [
  ...
  },
  {
    ...
    body: [
      'One person makes Nila, and Settings puts you in touch with them. If something is broken, say so. If the app ought to do something it does not yet, say that too. Being sure of yourself is not a requirement, and neither is phrasing it well.',
      'Your version and the device you are on ride along with the message, so you can describe what you saw and leave the rest. What you have logged stays encrypted and stays out of it.',
      ...
      'Writing it offline is fine. It waits on your device and goes out by itself once you have a connection, so you can close the app and forget you sent it.',
    ],
    steps: [
      'Open Settings and find "Make Nila Yours".',
